...
const $bookmarkCloseText = document.getElementById("bookmark-close-btn-text");  //북마크 닫기 테스트
const $bookmarkOpenText = document.getElementById("bookmark-open-btn-text");    //북마크 열기 테스트
...
const $bookmarkBarToggle = () => {
    ...
    if (isBookmarkBarOpen === "close") { //isBookmarkBarOpen 값이 존재하고
